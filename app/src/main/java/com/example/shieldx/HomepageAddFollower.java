...
public class HomepageAddFollower extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homepage_addfollower);
        ...
        addFromNewFollower.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myIntent = new Intent(HomepageAddFollower.this, AddNewFollowerContact.class);
    ...
    private boolean checkPermission() {
        //check condition
        boolean result = ContextCompat.checkSelfPermission(HomepageAddFollower.this, Manifest.permission.READ_CONTACTS)
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == CONTACT_PERMISSION_CODE && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(HomepageAddFollower.this, "Permission Denied.", Toast.LENGTH_SHORT).show();
